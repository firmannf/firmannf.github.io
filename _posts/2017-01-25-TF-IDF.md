...
* Second, we have to compute Inverse Document Frequency (IDF). The formula is `log(total number of documents <b>divided by</b> number of documents where the word appeared)`.
