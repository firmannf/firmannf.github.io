...
* First, we have to compute Term Frequency (TF). TF mesaures how frequently a word appeared in a document. The formula is `number of times a word show up in the document divided by total number of words in that document`.
